...
public class towerBoardGame {
    public static void main(String[] args) {
        ...
        while ((towerOpen[0][0]) || (towerOpen[0][1]) || towerOpen[1][0] || towerOpen[1][1]) {
            ...
            System.out.println("ODD Towers: " + towers[0][0] + " (open: " + towerOpen[0][0] + "), " + towers[0][1] + " (open: " + towerOpen[0][1] + ")");
            System.out.println("EVEN Towers: " + towers[1][0] + " (open: " + towerOpen[1][0] + "), " + towers[1][1] + " (open: " + towerOpen[1][1] + ")");
            System.out.println();
        }
    }
    ...
    public static void playerTurn(int[] towers, boolean[] towerOpen, int limitedTowerScore, int methodDice, String typeOfPlayer) {
        ...
        do {
            ...
            for (int i = 0; i < towers.length; i++) {
                System.out.println((i + 1) + ". " + typeOfPlayer + "Tower" + (i + 1) + " (Current: " + typeOfPlayer + ", Open: " + towerOpen[i] + ")");

                System.out.println("Please select Tower 1 or 2 :");
                userTowerChoice = inputs.nextInt() - 1;

                if (userTowerChoice < 0 || userTowerChoice > 2) {
        ...
        if (towers[userTowerChoice] > limitedTowerScore) {
            towers[userTowerChoice] = limitedTowerScore;
